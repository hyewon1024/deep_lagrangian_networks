...
def replay_buffer(data, batch_size):
    ...
    train_qp, train_qv, train_qa, torque = data_torch
...
if __name__ == "__main__":
    ...
    test_data= generate_rand_data_with_pd_control(env, ntrajs=20, traj_len=10, dt=0.05, kp=50, kr=10)
    ...
    all_data = {key: [] for key in [
        'q','qd', 'qdd', 'delan_tau', 'delan_dEdt', 'delan_m', 'delan_c', 'delan_g'
    ]}
    ...
    output_path = os.path.join(metric_folder, 'metrics_tau.mat')
